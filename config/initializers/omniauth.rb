Rails.application.config.middleware.use OmniAuth::Builder do
    ...
    provider :linked_in, '1ihgp8p3i0el', '0dMY7GrhM2CNeiPS', :scope => "r_network"
    provider :google, 'CONSUMER_KEY', 'CONSUMER_SECRET'
end

Twitter.configure do |config|
  config.consumer_key = 'GW1ityUv8MFlLyDmVGdA'
  config.consumer_secret = 'e2Pydt41is3ROit90avIR1bftc3FqHMkxr5bLC8U'
end
